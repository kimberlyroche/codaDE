...
# `counts` should be features x samples
plot_relab <- function(counts, groups, k = 20, use_props = TRUE, save_name = NULL,
                       height = 4, width = 6, palette = NULL) {
...
song <- parse_Song(absolute = FALSE)
...
plot_relab(song$counts, song$groups, k = 200, use_props = FALSE, save_name = "song_03.png")
...
plot_relab(muraro$counts[,idx_subset], muraro$groups[idx_subset], k = 5000, use_props = FALSE, save_name = "muraro_03.png")
