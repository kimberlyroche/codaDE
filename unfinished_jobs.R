...
option_list = list(
  ...
  make_option(c("--prop_da"), type = "numeric", default = NULL, 
              help = "proportion of differentially abundant genes", metavar = "numeric"),
  make_option(c("--sfcorr"), type = "numeric", default = NULL, 
              help = "correlation of true and observed total abundances", metavar = "numeric"),
